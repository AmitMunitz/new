<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Rook.aspx.cs" Inherits="End_Project.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceBody" runat="server">
	...
	<script>
        ...
        function moveRook(event) {
            ...
            var index = Array.from(squares).indexOf(target);

			if (index < 0 || index > 63) return;

            var x = index % 8;
            var y = Math.floor(index / 8);
            var currentX = rookPosition % 8;
            var currentY = Math.floor(rookPosition / 8);
